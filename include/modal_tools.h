...
namespace mtk
{
    ...
    */
    template <typename Type>
    Type ComputeMAC(mtk::EigenPair<Type> pair1, mtk::EigenPair<Type> pair2)
    {
        return mtk::ComputeMAC(pair1.evector, pair2.evector);
    };
    ...
    */
    template <typename Type>
    Eigen::Matrix<Type, Eigen::Dynamic, Eigen::Dynamic> ComputeMAC(mtk::ModeSet<Type> set1,
                                                                   mtk::ModeSet<Type> set2)
    {
        ...
        for (int i = 0; i < set1.Size(); ++i)
        {
            ...
            {
                mac(i, j) = mtk::ComputeMAC(set1[i].evector, set2[j].evector);
            }
        }
